...
enum procFlags
{
	PROC_NONE						= 0x00000000,
    PROC_ATTACK_MELEE				= 0x00000001,              // On melee hit
    PROC_STRUCK_MELEE				= 0x00000002,              // On being struck melee
    PROC_GAIN_XP_HK					= 0x00000004,              // On kill target giving XP or honor
    PROC_CAST_SPECIFIC_SPELL		= 0x00000008,              // check to replace affected schools
    PROC_DODGE						= 0x00000010,              // On dodge
    PROC_PARRY						= 0x00000020,              // On parry
    PROC_BLOCK						= 0x00000040,              // On block
    PROC_TAGRGET_SELF				= 0x00000080,              // Decide if proc target is self or victim
    PROC_ON_DEATH					= 0x00000100,              // On death
	PROC_MISC						= 0x00000200,              // General usage Flag - for now used on shield spells
    PROC_STRUCK_RANGED				= 0x00000400,              // On being struck ranged
    PROC_ATTACK_AUTO_SHOT			= 0x00000800,              // Auto shot hit
    PROC_ATTACK_MELEE_CRIT			= 0x00001000,              // On crit melee
    PROC_STRUCK_MELEE_CRIT			= 0x00002000,              // On being critically struck in melee
    PROC_CAST_SPELL					= 0x00004000,              // On cast spell
    PROC_ANY_DAMAGE_TAKE			= 0x00008000,              // On take damage
    PROC_SPELL_CRIT					= 0x00010000,              // On crit spell
    PROC_HIT_SPELL					= 0x00020000,              // On hit spell
    PROC_STRUCK_SPELL_CRIT			= 0x00040000,              // On being critically struck by a spell
    PROC_ATTACK_RANGED				= 0x00080000,              // On getting ranged hit
    PROC_STRUCK_SPELL				= 0x00100000,              // On being struck by a spell
    PROC_TRAP						= 0x00200000,              // On trap activation -- TODO
    PROC_CRIT_RANGED				= 0x00400000,              // On getting ranged crit
    PROC_STRUCK_RANGED_CRIT			= 0x00800000,              // On being critically struck by a ranged attack
    PROC_RESIST_SPELL				= 0x01000000,              // On resist enemy spell
    PROC_ABSORB						= 0x02000000,              // On full dmg absorbtion
    PROC_TARGET_DODGE_OR_PARRY		= 0x04000000,              // On enemy dodges/parries
    PROC_HEAL						= 0x08000000,              // On heal
    PROC_CRIT_HEAL					= 0x10000000,              // On critical healing effect
    PROC_HEALED						= 0x20000000,              // On healing
    PROC_TARGET_BLOCK				= 0x40000000,              // On enemy blocks
    PROC_REMOVEONUSE				= 0x80000000				
};
