    ...
    Revelosh(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		for(int i=0;i<nrspells;i++)
		{
			m_spellcheck[i] = false;
		     ...
		     spells[0].info = SpellDataStorage.LookupEntry(10392);
		     spells[0].cooldown = 10;
		     spells[0].targettype = TARGET_ATTACKING;
		     spells[0].instant = true;
		     spells[0].perctrigger = (float)sRand.rand(20.0f);
		     ...
		     spells[1].info = SpellDataStorage.LookupEntry(2860);
    ...
    Grimlok(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		for(int i=0;i<nrspells;i++)
		{
			m_spellcheck[i] = false;
		     ...
		     spells[0].info = SpellDataStorage.LookupEntry(8292);
		     spells[0].cooldown = 10;
		     spells[0].targettype = TARGET_ATTACKING;
		     spells[0].instant = true;
		     spells[0].perctrigger = (float)sRand.rand(20.0f);
		     ...
		     spells[1].info = SpellDataStorage.LookupEntry(10392);
		     spells[1].cooldown = 10;
		     spells[1].targettype = TARGET_ATTACKING;
		     spells[1].instant = true;
		     spells[1].perctrigger = (float)sRand.rand(20.0f);
		     ...
		     spells[2].info = SpellDataStorage.LookupEntry(8066);
    ...
    Baelog(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		for(int i=0;i<nrspells;i++)
		{
			m_spellcheck[i] = false;
		     ...
		     spells[0].info = SpellDataStorage.LookupEntry(15613);
		     spells[0].cooldown = 10;
		     spells[0].targettype = TARGET_ATTACKING;
		     spells[0].instant = true;
		     spells[0].perctrigger = (float)sRand.rand(20.0f);
    ...
    GalgannFirehammer(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		for(int i=0;i<nrspells;i++)
		{
			m_spellcheck[i] = false;
		     ...
		     spells[1].info = SpellDataStorage.LookupEntry(18958);
		     spells[1].cooldown = 10;
		     spells[1].targettype = TARGET_ATTACKING;
		     spells[1].instant = true;
		     spells[1].perctrigger = (float)sRand.rand(20.0f);
		     ...
		     spells[2].info = SpellDataStorage.LookupEntry(12470);
		     spells[2].cooldown = 10;
		     spells[2].targettype = TARGET_ATTACKING;
		     spells[2].instant = true;
		     spells[2].perctrigger = (float)sRand.rand(20.0f);
    ...
    Ironaya(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		for(int i=0;i<nrspells;i++)
		{
			m_spellcheck[i] = false;
		     ...
		     spells[0].info = SpellDataStorage.LookupEntry(16169);
		     spells[0].cooldown = 10;
		     spells[0].targettype = TARGET_ATTACKING;
		     spells[0].instant = true;
		     spells[0].perctrigger = (float)sRand.rand(20.0f);
