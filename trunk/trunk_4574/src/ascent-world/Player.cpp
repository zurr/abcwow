...
//		float amt = (Spirit*ClassMultiplier[cl]+ClassFlatMod[cl])*PctPowerRegenModifier[POWER_TYPE_MANA]*0.5f; // pre-2.4
		float amt = ( 5 * (0.001 + sqrt((float)Intellect) * Spirit * BaseRegen[level-1]) )*PctPowerRegenModifier[POWER_TYPE_MANA]*0.5f;
