...
void Pet::SendNullSpellsToOwner()
{
	...
	data << uint64(0);
	if (m_Owner != NULL) // How can an Pet exist without an owner?
...
void Pet::ApplySummonLevelAbilities()
{
	...
	*/
	...
	static double R_mod_sta[6] = {1.173913043, 4.05, 4.525, 4.525, 4.525, 3.199};
	...
	static double R_mod_armor[6] = {31.69565217, 139.6, 74.62, 89.175, 101.1316667, 50};
	static double R_pet_sta_to_hp[6] = {2.8, 15.0, 7.5, 10.0, 10.6, 10.0};
