...
const char * DurabilityCostsFormat = "uiiiiiiiiiiiiiiiiiiiiiiiiiiiii";
...
bool LoadDBCs()
{
	...
	LOAD_DBC("DBC/DurabilityQuality.dbc", DurabilityQualityFormat, true, dbcDurabilityQuality);
	LOAD_DBC("DBC/DurabilityCosts.dbc", DurabilityCostsFormat, true, dbcDurabilityCosts);
